...
import 'package:sammir2/Hal%206.dart';
...
class _NavBarState extends State<NavBar> {
  ...
  final _halaman = [Hal1(),Hal2(),Hal3(),Hal4(),Hal5(),Hal6() ]; //listing of all 5 page

  final bgcolor = [Colors.green,Colors.red,Colors.lightGreenAccent,Colors.yellow,Colors.orange,Colors.cyan]; //color changing
